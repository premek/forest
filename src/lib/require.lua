...
function require.treeArray(requirePath)
  local t = require.tree(requirePath)
  local a = {}
  for name in pairs(t) do table.insert(a, name) end
  table.sort(a)
  local t2 = {}
  for i, name in ipairs(a) do t2[i] = t[name] end
  return t2
end
